...
UPDATE concept_name SET NAME= 'Drug resistant Tuberculosis (DRTB) inteke note' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='DR TB Intake note';
...
UPDATE concept_name SET NAME= 'DR TB intake note' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Drug resistant Tuberculosis (DRTB) inteke note' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );