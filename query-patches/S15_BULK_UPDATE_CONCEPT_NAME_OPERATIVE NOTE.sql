...
UPDATE concept_name SET NAME= 'Oxygen saturation' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Oxygen saaturation data' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
