...
UPDATE concept_name SET NAME= 'Contact number (follow up)' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'ANC-Mother's contact number' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
