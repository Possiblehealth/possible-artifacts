...
UPDATE concept_name SET NAME= 'Retained placenta' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Retained Placenta, without hemmorage';
UPDATE concept_name SET NAME= 'PNC-Postpartum hemorrage ' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='PNC-Post-partum hemorrhage';
...
UPDATE concept_name SET NAME= 'PNC-Postpartum IUCD' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='PNC - Post-partum IUCD';
...
UPDATE concept_name SET NAME= 'Not applicable' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Not Applicable';
UPDATE concept_name SET NAME= 'PNC-Postpartum FP chosen' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='PNC - Post-partum FP chosen';
...
UPDATE concept_name SET NAME= 'HTC-Result if tested' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='HCT, Result if tested';
...
UPDATE concept_name SET NAME= 'Visit date' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'PNC-Visit date' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Postpartum hemorrage' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'PNC-Postpartum hemorrage ' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Blood transfusion quantity (pint)' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'PNC-Blood transfusion quantity' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'PP IUCD' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'PNC-Postpartum IUCD' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Not applicable' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Not applicable' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
UPDATE concept_name SET NAME= 'Postpartum FP chosen' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'PNC-Postpartum FP chosen' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Result if tested' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'HTC-Result if tested' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
