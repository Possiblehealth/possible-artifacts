...
UPDATE concept_name SET NAME= 'TB Intake-Hospitalizations due to TB in last 3 months' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Tuberculosis, Hospitalizations due to TB in last 3 months';
UPDATE concept_name SET NAME= 'Current smoker' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Congestive Heart Failure - Intake - Exposures - Current Smoker';
...
UPDATE concept_name SET NAME= 'Smoking status' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='CD, Smoking status';
UPDATE concept_name SET NAME= 'TB Intake-At the time of TB diagnosis' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Tuberculosis, At the time of TB diagnosis, Patient tested for HIV';
...
UPDATE concept_name SET NAME= 'TB Intake note' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Tuberculosis, Intake Note';
...
UPDATE concept_name SET NAME= 'Hospitalizations due to TB in last 3 months' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'TB Intake-Hospitalizations due to TB in last 3 months' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Smoking status' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Smoking status' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
UPDATE concept_name SET NAME= 'At the time of TB diagnosis' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'TB Intake-At the time of TB diagnosis' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );
...
UPDATE concept_name SET NAME= 'Tuberculosis intake note' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'TB Intake note' AND concept_name_type='FULLY_SPECIFIED' limit 1) a );