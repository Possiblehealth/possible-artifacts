...
UPDATE concept_name SET NAME= 'Heat / cold intolerence' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Heat / Cold Intolerence';
...
UPDATE concept_name SET NAME= 'ER-Heme / lymph' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='ER General Notes, Heme / Lymph';
...
UPDATE concept_name SET NAME= 'N/V/D/C' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='N/V/D/C';
...
UPDATE concept_name SET NAME= 'ER-Skin / breast' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='ER General Notes, Skin / Breast';
...
UPDATE concept_name SET NAME= 'Vaginal / penile discharge' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='Vaginal / Penile Discharge';
...
UPDATE concept_name SET NAME= 'ER-Heavy / light' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='ER General Notes, Heavy / Light';
...
UPDATE concept_name SET NAME= 'ER-Assessment / Plan' WHERE concept_name_type='FULLY_SPECIFIED' AND NAME='ER General Notes, Assessment / Plan';
...
UPDATE concept_name SET NAME= 'Heat / cold intolerence' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Heat / cold intolerence' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'Heme / lymph' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'ER-Heme / lymph' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'N/V/D/C' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'N/V/D/C' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'Skin / breast' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'ER-Skin / breast' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'Vaginal / penile discharge' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'Vaginal / penile discharge' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'Heavy / light' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'ER-Heavy / light' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
...
UPDATE concept_name SET NAME= 'Assessment / Plan' WHERE concept_name_type='SHORT' AND CONCEPT_ID=(SELECT a.CONCEPT_ID FROM (select * from concept_name WHERE NAME = 'ER-Assessment / Plan' AND concept_name_type='FULLY_SPECIFIED limit 1') a );
